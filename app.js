...
switch(mode) {
    case 'signal':
        ...
        */
        ...
        var tcpServer = new TcpListener(serverConfig.tcpPort, commandHistory, targetConfig, serverConfig.target);
